...
public class QuestionsAnswersTextTest {
...
public QuestionsAnswersTextTest(int number, String text){
    this.number = number;
    this.text = text;
    }
    ...
    public void questionsAnswersTextTest() {
        ...
        driver_main = new ChromeDriver(options);
        // переходим на страницу тестового приложения
        driver_main.get("https://qa-scooter.praktikum-services.ru/");
        //создай объект класса
        MainPage objMainPage = new MainPage(driver_main);
